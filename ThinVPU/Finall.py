# -*- coding: utf-8 -*-
"""
Created on Tue Nov 24 17:33:46 2020
...
path = glob.glob("C:/Users/s/Desktop/crater_nav/out/*.tif")
...
for img in path:
   ...
   #print(u_sun_values)
    #a= u_sun_values.loc[4437].at['U_sun_x']
    #b= u_sun_values.loc[4437].at['U_sun_y']
    print(a)
    print(b)
    u_sun = np.array([a,b])
    print(u_sun)
    ...
    cv2.imwrite('result222.png', framec)
...
df1 = pd.read_excel (r'C:/Users/s/Desktop/crater_nav/resource/metadata.xlsx')

# Retrieving the specific metadata row based on the input
result = df1.loc[df1['Image Name'] == 'M104433648RC_pyr.tif']
...
print(final_df)
final_df.to_csv('C:/Users/s/Desktop/crater_nav/listfinal1.csv', index=False,header=True)
